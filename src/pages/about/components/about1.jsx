    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      ...
      <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
        <div className="w-full lg:w-6/12">
          <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
            ConsultMe, menyediakan dukungan kesehatan mental yang penuh empati
          </h2>
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            Misi kami adalah menciptakan ruang yang aman dan nyaman, di mana
            setiap orang dapat berbagi perasaan, menghadapi tantangan, dan
            bekerja menuju pola pikir yang lebih sehat. Kami percaya bahwa
            setiap orang berhak untuk berbicara tentang kesehatan mentalnya
            tanpa stigma atau penilaian.
          </p>
        </div>
        <div className="w-full lg:w-6/12">
          <img
      ...
      <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
        <div>
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            ConsultMe berdiri sejak tahun 2021 dan telah membantu ratusan orang
            di Indonesia.
          </p>
        </div>
        <div>
          <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">
            100K Enrichment Bulanan
          </p>
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            Dengan layanan kami, jutaan pengguna mendapatkan wawasan baru dan
            kemajuan dalam perjalanan kesehatan mental mereka setiap bulannya.
          </p>
        </div>
        <div className="sm:block hidden">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            Lebih dari 10 ribu orang telah mempercayakan kebutuhan konseling
            mereka kepada kami untuk mendukung kesehatan mental yang lebih baik.
          </p>
        </div>
      </div>
      ...
      <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
        <div className="w-full lg:w-6/12">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
            Kami berdedikasi untuk menyediakan layanan konsultasi psikologi yang
            dapat diakses dengan mudah dan aman, mendukung setiap individu untuk
            menemukan keseimbangan mental yang lebih baik. Kami percaya bahwa
            kesehatan mental adalah hak bagi semua orang, dan kami berkomitmen
            membantu setiap klien melalui pendekatan yang penuh empati, tanpa
            stigma atau penilaian.
          </p>
          <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-10">
            Misi kami adalah menjadi tempat di mana Anda dapat merasa nyaman
            untuk berbagi dan mendapatkan dukungan dari profesional yang
            berpengalaman. Bersama-sama, kami ingin membantu Anda mencapai
            kualitas hidup yang lebih baik melalui peningkatan kesehatan mental
            yang berkelanjutan.
          </p>
        </div>
        <div className="w-full lg:w-6/12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
            ...
            <div className="flex p-4 shadow-md">
              ...
              <div className="">
                ...
                <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                  Tim kami terdiri dari psikolog dan konselor berlisensi yang
                  berdedikasi untuk mendukung Anda dalam setiap langkah
                  perjalanan kesehatan mental Anda. Dengan pengalaman dan
                  keahlian, kami hadir untuk mendengarkan dan membantu Anda
            ...
            <div className="flex p-4 shadow-md">
              ...
              <div className="">
                ...
                <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                  Dewan kami terdiri dari para profesional berpengalaman di
                  bidang kesehatan mental yang berdedikasi untuk memastikan
                  bahwa layanan kami selalu berkualitas tinggi, aman, dan
                  terpercaya. Dengan visi dan komitmen yang kuat, mereka
                  memimpin tim kami dalam memberikan dukungan terbaik bagi
                  setiap klien.
                </p>
              </div>
            </div>
            ...
            <div className="flex p-4 shadow-md">
              ...
              <div className="">
                ...
                <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                  Kami bangga telah dipercaya oleh berbagai media untuk berbagi
                  wawasan dan informasi terkait layanan kesehatan mental kami.
                  Dengan dukungan media, kami berharap dapat meningkatkan
                  kesadaran tentang pentingnya kesehatan mental bagi semua
                  kalangan.
                </p>
              </div>
            </div>
